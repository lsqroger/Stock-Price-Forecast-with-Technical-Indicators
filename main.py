...
#bucket = client.get_bucket('staging.stock-forecasts-with-roger.appspot.com')
...
def ml_fcst():
    ...
    if req_type == 'GET':
        ...
        if (prediction['error'] != 'error') and (prediction['error'] != 'notTrading'):
            ...
            ax.figure.savefig('/tmp/cm.png') #stock-forecasts-with-roger.appspot.com
            prediction['cm_link'] = '/tmp/cm.png' #'/static/cm.png'
            ...
            plt.savefig('/tmp/roc_figure.png')
            prediction['figure_link'] = '/tmp/roc_figure.png'   #'/static/roc_figure.png'
